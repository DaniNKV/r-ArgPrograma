...
textTitle.textContent = "Que onda guacho"
...
const imagenPpal = document.querySelector('img');
imagenPpal.src = ("img/kittens.jpeg");
...
textTitle.style.color = "pink";
textTitle.style.textShadow = "1 1 red";
...
/*
const botonIngreso = document.querySelector('#ingresar');  /*El $ es para indicar elemento*/
/*
document.querySelector("#entrada-bar").onsubmit = function (event);

botonIngreso.onclick = function (evento) { /* Onclick espera a una funcion cuando hagan click */
