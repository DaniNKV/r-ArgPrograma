...
console.log("nombre de variable 1 es: " + numeroUno);
console.log("nombre de variable 2 es: " + numeroDos);
...
/*
let anio_Nacimiento = 1997
let anio_Actual = 2021

let miEdad = restar(anio_Actual, anio_Nacimiento);
    console.log("Mi edad es: " + miEdad); 

let edadUsuario = prompt("Ingrese su edad", "30")
...
*/
/*
function years(añoActual, añoNaciomiento){
    return restar(añoActual, añoNaciomiento)
};

const añoActual = Number(prompt("Que año es? "));
const añoNacimiento = Number(prompt("En que año nació? "));
...
/*
function calcularSalario_Mensual(SalarioAnual) {
    const mesesEnAño = 12
    return salarioAnual / mesesEnAño;
}

function calcularSalario_anual (SalarioMensual){
    const semanasEnAño = 52
    return salarioAnual / semanasEnAño
};

function calcularSalario_diario (SalarioAnual){
    const diasEnAño = 365
    return salarioAnual / diasEnAño
};

function calcularSalario_hora (salarioAnual){
    const horasEnDia = 24
    const diasEnAño = 365
    return salarioAnual / horasEnDia * diasEnAño
};

const salario_mensual = Number (
    prompt("Ingrese su salario Anual"));
    
console.log ("Su salario Mensual es: " + calcularSalario_Mensual);
console.log ("Su salario diario es: " + calcularSalario_diario );
console.log ("Su salario por hora es: " + calcularSalario_hora)
/*
...
/*
let numero1 = Number(prompt("Inserte un numero"))
let numero2 = Number(prompt("Inserte otro numero"))
*/
/*
const operador = "+";
const numero1 = 1
...
let resultado
if operador === "+" {
    resultado = function sumar(numero1,numero2);{
       console.log (suma)
    } 
else: {
  resultado = function restar(numero1, numero2){
       console.log(restar)
   }
}
*/
...
const operador = prompt ("Ingrese operador aritmético")
...
if (operador === "+") {
    ...
    console.log ("Perdon, no te entendí");
}

console.log("El resultado de " + numero1 " y " + numero2 "es" + resultado)
console.log(
    `El resultado de ${numero1} y ${numero2} es ${resultado}`);
