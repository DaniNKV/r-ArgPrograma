...
//       cosas que te gustan.
 ...
 //let comidasFavoritas = ["milanesas", "pastas", "pizzas"]; 
...
/*
console.log(let comidasFavoritas[2])
*/
...
//comidasFavoritas.push("papas fritas")
...
for ( i=0; i < comidasFavoritas.length; i++ ){
    console.log("Me gustan las " + comidasFavoritas[i]);
}
